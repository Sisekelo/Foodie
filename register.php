...
if (strpos($email, 'alustudent') === false) {
    $sql = "INSERT INTO nonALU (name,surname,email,number,picture,RoomNumber,Referer)
            VALUES ('$first_name','$last_name','$email','$number','$picURL','$room $residence','$referer')";
    $mysqli->query($sql);

    $_SESSION['emoji'] = "&#x1F625;";
    $_SESSION['message'] = 'Thank you for the enthusiasm but Oui Deliver is only open for ALU students.';
