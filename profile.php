    ...
    <div id="mainbackground" style="background: #04c8ba">
      <div id="mainPage">
        <div id="message">
         ...
         <div class="sidebar" style="height: 100vh;z-index: 10000">
          ...
          <div id="picInfo" style="height: 20%" class="center">
            <img style="height: 50%; float: left;position: absolute;top: 25%; left: 5%;-ms-transform: translate(-50%, -50%); " src="img/truck.png">
            <p style="display: inline-block; font-family: Avenir; font-size: 100%;">Hi,<?= $first_name ?><br>You have <?= $points ?> Points</p>
          </div>

          <hr length="50%" style="color: black">

          <div id="Help" style="height:80%">
         
            <p style="margin-left: 2%;font-family: Avenir;font-size: 120%">Profile </p><br>
            <p style="margin-left: 2%;font-family: Avenir;font-size: 120%">Profile </p><br>
            <p style="margin-left: 2%;font-family: Avenir;font-size: 120%">Profile </p><br>
            <p style="margin-left: 2%;font-family: Avenir;font-size: 120%">Profile </p><br>
            <p style="margin-left: 2%;font-family: Avenir;font-size: 120%">Profile </p><br>
        ...
        <div id="Messages1" class="center">
          ...
          <div  id="Messages2" class="center"><p><strong id="top2">Click below to order</strong></p></div>
